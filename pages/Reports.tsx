...
export const Reports: React.FC = () => {
  ...
  const monthlyOrders = orders.filter(o => o.deliveryDate.startsWith(month) && o.status === 'Entregado');
  const allMonthlyOrders = orders.filter(o => o.deliveryDate.startsWith(month));
