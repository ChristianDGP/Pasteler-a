...
export const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange }) => {
  return (
    <div className="flex flex-col h-screen bg-slate-50 lg:flex-row">
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-y-auto pb-[calc(4rem+env(safe-area-inset-bottom))] lg:pb-0 relative print:pb-0 print:overflow-visible">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 flex justify-around items-center z-50 pb-[env(safe-area-inset-bottom)] pt-1 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] overflow-x-auto">
